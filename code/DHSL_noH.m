function [Max_acc,Bestalpha,Bestbeta,Bestcreate,BestF_U,BestW,Y_predict,BestIter] = DHSL_noH(X,X_l,Y_l,X_u,Y_u)
% =========================================================================
...
createnums = [0.2,0.25,0.3,0.35,0.4,0.45,0.5,0.6];
