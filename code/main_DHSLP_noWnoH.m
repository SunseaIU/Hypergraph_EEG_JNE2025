...
for i = 1:15
    ...
    % main program
    [Max_acc,Bestr,Bestalpha,Bestcreate,BestF_U,BestM,Y_predict,BestIter] = DHSLP_noWnoH(X,X_l,Y_l,X_u,Y_u);
    ...
    save_path = ['../result/all channels/DHSLP_noWnoH/DHSLP_noWnoH_patient',num2str(patient),'_process',num2str(process_param)];
