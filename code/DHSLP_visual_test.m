function [Max_acc,Bestr,Bestalpha,Bestbeta,Bestcreate,BestF_U,BestM,BestH,BestW,Y_predict,BestIter,Bestfmbhs] = DHSLP_visual_test(X,X_l,Y_l,X_u,Y_u)
% =========================================================================
...
%                 end
                ...
                %% Loop Iteration
                fx11 = zeros(70,1); x1 = 3; x2 = [61:120,311:320];

                fD = pdist2(X,X,'euclidean');
                for i = 1:70
                    fx11(i,1) = fD(x1,x2(i))/mean(fD(x1,:));
                end
...
%                     w = w/sum(w);
    ...
    %                 fprintf('目标函数值： %.6f ，准确度： %.6f \n',mbhs,acc);
                    ...
                    newElement = fD(x1, x2) / mean(fD(x1, :));
                    newElement = newElement';
                    fx11 = horzcat(fx11,newElement);
