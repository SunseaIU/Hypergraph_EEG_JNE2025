...
for patient = 1:10
    ...
    for fold = 1:cv.NumTestSets
        ...
        % main program
        [Max_acc,Bestlambda,Bestalpha,Bestcreate,BestF_U,Besttheta,BestW,Y_predict,BestIter] = HSWCAN_Fl(X,X_l,Y_l,X_u,Y_u);
        ...
        result_struct = struct('Bestlambda',Bestlambda,'Bestalpha',Bestalpha,'Bestcreate',Bestcreate,'BestF_U',BestF_U,'Besttheta',Besttheta,'BestW',BestW,'Y_predict',Y_predict,'BestIter',BestIter);
        save_path = ['../result/session',session,'/DHSLF_noH/DHSLF_noH_patient',patient_str,'-',session,'process_',num2str(process_param),'_fold',num2str(fold)];
