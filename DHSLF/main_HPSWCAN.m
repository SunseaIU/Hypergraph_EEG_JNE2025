...
% main program
[Max_acc,Bestr,Bestlambda,Bestalpha,Bestbeta,Besteta,Bestcreate,BestF_U,BestT,Besttheta,BestW,Y_predict,BestIter,Bestfmbhs] = HPSWCAN(X,X_l,Y_l,X_u,Y_u);

% save result
fprintf('Bestr: %d , Bestlambda: %.4f , Bestalpha: %.4f , Bestbeta: %.4f , Besteta: %.4f , Bestcreate: %.2f , the best acc: %.4f \n',Bestr,Bestlambda,Bestalpha,Bestbeta,Besteta,Bestcreate,Max_acc);
result_struct = struct('Bestr',Bestr,'Bestlambda',Bestlambda,'Bestalpha',Bestalpha,'Bestbeta',Bestbeta,'Besteta',Besteta,'Bestcreate',Bestcreate,'BestF_U',BestF_U,'BestT',BestT,'Besttheta',Besttheta,'BestW',BestW,'Y_predict',Y_predict,'BestIter',BestIter,'function_value',Bestfmbhs);
save_path = ['../result/HPSWCAN_create_patient',num2str(patient),'_process',num2str(process_param)];
figure;
