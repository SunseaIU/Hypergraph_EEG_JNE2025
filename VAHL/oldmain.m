...
% save result
result_struct = struct('Bestalpha',Bestalpha,'Bestbeta',Bestbeta,'Bestgamma',Bestgamma,'BestF_U',BestF_U,'BestW',BestW,'Y_predict',Y_predict,'BestIter',BestIter);
save_path = ['../result/OGSSL_process_',num2str(process_param)];
