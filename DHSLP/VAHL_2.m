function [Max_acc,Bestr,Bestalpha,Bestbeta,Bestcreate,BestF_U,BestM,BestH,BestW,Y_predict,BestIter] = VAHL_2(X,X_l,Y_l,X_u,Y_u)
% =========================================================================
...
%                 fprintf('r: %d , create: %.2f, alpha: %.4f , beta: %.4f ,current acc: %.4f, the best acc: %.4f \n',r,create,alpha,beta,current_acc,Max_acc);
                current_acc = 0;
