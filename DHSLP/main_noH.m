...
for patient = 1:10
    ...
    for fold = 1:cv.NumTestSets
        ...
        % main program
        [Max_acc,Bestr,Bestalpha,Bestbeta,Bestcreate,BestF_U,BestM,BestW,Y_predict,BestIter] = VAHL_2_noH(X,X_l,Y_l,X_u,Y_u);
        ...
        result_struct = struct('Bestr',Bestr,'Bestalpha',Bestalpha,'Bestbeta',Bestbeta,'Bestcreate',Bestcreate,'BestF_U',BestF_U,'BestM',BestM,'BestW',BestW,'Y_predict',Y_predict,'BestIter',BestIter);
        save_path = ['../result/session',session,'/DHSLP_noH/DHSLP_noH_patient',patient_str,'-',session,'process_',num2str(process_param),'_fold',num2str(fold)];
        % figure;
