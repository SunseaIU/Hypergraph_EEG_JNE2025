...
for i = 1:15
    ...
    % main program
    [Max_acc,Bestlambda,Bestalpha,Bestcreate,BestF_U,Besttheta,BestH,BestW,Y_predict,BestIter,Bestfmbhs] = HSWCAN_Fl_H(X,X_l,Y_l,X_u,Y_u);
    ...
    save_path = ['../result/HSWCAN_Fl_H_patient',num2str(patient),'_process',num2str(process_param)];
...
saveas(gcf,'../result/15subjects_Fl_H_process6.fig');
t2 = clock;
