...
% main program
[Max_acc,Bestlambda,Bestk,Bestalpha,Bestbeta,Bestcreate,BestF_U,Besttheta,BestW,Y_predict,BestIter,Bestfmbhs] = HSWCAN_k(X,X_l,Y_l,X_u,Y_u);

% save result
fprintf('Bestlambda: %.4f , Bestk: %d , Bestalpha: %.4f , Bestbeta: %.4f , Bestcreate: %.2f , the best acc: %.4f \n',Bestlambda,Bestk,Bestalpha,Bestbeta,Bestcreate,Max_acc);
result_struct = struct('Bestlambda',Bestlambda,'Bestk',Bestk,'Bestalpha',Bestalpha,'Bestbeta',Bestbeta,'Bestcreate',Bestcreate,'BestF_U',BestF_U,'Besttheta',Besttheta,'BestW',BestW,'Y_predict',Y_predict,'BestIter',BestIter,'function_value',Bestfmbhs);
save_path = ['../result/HSWCAN_k_patient',num2str(patient),'_process',num2str(process_param)];
figure;
