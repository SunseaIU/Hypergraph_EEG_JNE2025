...
for i = 1:15
    ...
    % main program
    [Max_acc,Bestlambda,Bestcreate,BestF_U,Besttheta,Y_predict,BestIter] = DHSLF_noWnoH(X,X_l,Y_l,X_u,Y_u);
    ...
    save_path = ['../result/DHSLF_noWnoH/DHSLF_noWnoH_patient',num2str(patient),'_process',num2str(process_param)];
